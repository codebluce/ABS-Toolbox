...
issues:
  ...
  - id: REV-v2.2-v22-pricing-r01-03
    ...
    blocks_approval: false
    resolution: "已修复。Agent B 于审计后经用户确认顺手将 SKILL.md L3 version 由 2.0.0 升至 2.2.0,与 description/送审 skill_version 一致。status=resolved。"
...
conditions:
  ...
  - "[已修复] SKILL.md frontmatter version 2.0.0 已升级为 2.2.0(REV-03,resolved),审计后由 B 顺手修正,无需 C 处理"
---
...
- **REV-03**: SKILL.md frontmatter version="2.0.0" 未升至 2.2.0(v21 轮即存在,非本轮引入)。**[已修复]** 审计后由 B 顺手升至 2.2.0,resolved。
...
3. SKILL.md version 升级 → [已修复] 审计后由 B 顺手升至 2.2.0,resolved,C 归档时确认即可
