...
| v22-pricing | r1 | REVIEWED / APPROVED_WITH_CONDITIONS | ✅ 4/4 | 2026-07-05 | `audit/v2.2-v22-pricing-r01`(✅已双推) | `1e14550` | [A1-v22-pricing-r1.md](submissions/A1-v22-pricing-r1.md) |
...
| v22-pricing | r1 已审计(APPROVED_WITH_CONDITIONS) | 待 Agent C 归档 | 发行定价 v1.5.0 迁入;功能等价性完整无回归(4 文件仅路径改造/abs_common 字节一致/QC FAIL 经源脚本对比证实为 0626 数据问题);3 项 DOC_CONSISTENCY 瑕疵待 C 留档 |
